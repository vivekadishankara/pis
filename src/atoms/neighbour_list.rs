...
impl Atoms {
    pub fn rcut_cells(&self, nx: usize, ny: usize, nz: usize) -> Vec<Vec<usize>> {
        ...
        for (i, r_i) in self.positions.column_iter().enumerate() {
            ...
            if self.sim_box.pbc[0] { cx_i = cx_i % nx; }
            if self.sim_box.pbc[1] { cy_i = cy_i % ny; }
            if self.sim_box.pbc[2] { cz_i = cz_i % nz; }
...
pub const FORWARD_NEIGHBOUR_OFFSETS: [Offset3; 14] = [
    Offset3 { dx: 0, dy: 0, dz: 0 },  // self cell
    Offset3 { dx: 1, dy: 0, dz: 0 },
    Offset3 { dx: -1, dy: 1, dz: 0 },
    Offset3 { dx: 0, dy: 1, dz: 0 },
    Offset3 { dx: 1, dy: 1, dz: 0 },
    Offset3 { dx: -1, dy: -1, dz: 1 },
    Offset3 { dx: 0, dy: -1, dz: 1 },
    Offset3 { dx: 1, dy: -1, dz: 1 },
    Offset3 { dx: -1, dy: 0, dz: 1 },
    Offset3 { dx: 0, dy: 0, dz: 1 },
    Offset3 { dx: 1, dy: 0, dz: 1 },
    Offset3 { dx: -1, dy: 1, dz: 1 },
    Offset3 { dx: 0, dy: 1, dz: 1 },
    Offset3 { dx: 1, dy: 1, dz: 1 },
